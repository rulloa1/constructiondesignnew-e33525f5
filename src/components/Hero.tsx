  ...
  return <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 via-black/50 to-transparent py-16 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-light text-white mb-4 [text-shadow:0_0_20px_rgba(228,179,33,0.3),0_0_40px_rgba(228,179,33,0.15)] md:text-4xl">30+ Years of Quality Craftsmanship</h2>
